  ...
  postData(getCreditApiUrl, requestCredit)
    .then((data) => {
      ...
      if (dataCredit.credit_points >= 3500) {
        qualifiedMessage.innerHTML = `<span class="text-primary-color text-center mt-6 mb-6 lh-25"><strong>Congratulations, you’ve been entered into the lottery balloon!</strong></span>`;
      }
    })
    .catch((error) => {
    ...
    .then((data) => {
      ...
      switch (dataRegist.status_id) {
        case 2:
          ...
          <div class="col-lg-4">
            <button type="submit" onclick="getActionName(this.id)" id="createRegBtn" class="btn btn-create">Submit Registration</button>
          </div>

          `;
          regStatus.innerText = "You haven’t signed up yet";
          guestName.classList.remove("form-control-second");
          guestName.classList.add("form-control-first");
          guestBoxInfo.innerHTML = `<span class="fs-16 lh-22"><sup>*</sup>Only one name can be provided</span>`;
          gdpr.innerHTML = `
          
          <p class="small-font">At the event venue, acceptance of our <strong>General Data Protection Regulation</strong> is required
          for the use of images, audio, and video recordings made during the event. You can read it in advance by
          <a href="docs/nics-adatkezelesi-tajekoztato.pdf" target="_blank"> clicking here.</a></p>
          `;
          break;
        case 1:
          regActions.innerHTML = `
            ...
            <div class="">
              <button type="submit" onclick="getActionName(this.id)" id="updateRegBtn" class="btn btn-update">Update Registration</button>
            </div>
            <br>
            <hr>
            <span>If for any reason you can no longer attend the party, please cancel your registration to help us with preparations</span>
            <div class="pt-20">
              <button type="submit" onclick="getActionName(this.id)" id="deleteRegBtn" class="btn btn-delete">Delete Registration</button>
            </div>
          ...
          regStatus.innerText = "You’ve already submitted your registration";
          guestBoxInfo.innerHTML = `<span class="fs-16"><sup>*</sup>The name can be added or deleted later</span>`;
          guestNameLabel.innerText = "Name of Your Guest:";
        ...
        case 0:
          ...
          customerName.innerText = "Identification failed";
          regForm.innerHTML = ``;
        ...
        case 5:
          ...
          closedRegBox.innerHTML = `
            ...
            <span class="material-icons text-primary-color" id="regIcon">lock</span>
              <span><strong>The registration for the birthday event has now closed!</strong><br>
              <span class="d-block pt-10">If you’ve registered, we’ll see you at the party! If you can’t make it this time, don’t worry — there will be another chance to celebrate together in June 2026!
...
form.addEventListener("submit", (event) => {
  ...
  if (guestName.value.trim() !== "" && !isValidText(guestName.value)) {
    ...
    guestErrorMessage.innerHTML = `<label class"d-block pt-10 fs-16">Please, enter letters only</label>`;
  } else {
      ...
      postData(createRegistApiUrl, requestRegist)
        .then((data) => {
          ...
          if (dataRegist.status_id === 1) {
            ...
            <div class="alert alert-success" role="alert" id="bx">Thank you, you have successfully registered!
              <br>
              <br>
              <div class="loader">
                <div class="bar"></div>
              ...
              <br>
              <i>We will update your registration in a few seconds. <strong>You can check, modify, or delete it on this same page.</strong></i>
            </div>
            
              `;
            document.getElementById("createRegBtn").disabled = true;
          } else {
            messageOnSubmit.innerHTML = `<span class="alert alert-danger" role="alert">An error occurred during registration</span>`;
          }
        })
        .catch((error) => {
          console.error("Error:", error);
      ...
      postData(updateRegistApiUrl, requestRegist)
        .then((data) => {
          ...
          if (dataRegist.status_id === 1) {
            ...
            <div class="alert alert-success" role="alert" id="bx">You have successfully updated your registration
              <br>
              <br>
              <div class="loader">
                <div class="bar"></div>
            ...
            messageOnSubmit.innerHTML = `<span class="alert alert-danger" role="alert">An error occurred while updating the registration</span>`;
          }
        })
        .catch((error) => {
          console.error("Error:", error);
      ...
      postData(deleteRegistAPiUrl, requestRegist)
        .then((data) => {
          ...
          if (dataRegist.status_id === 1) {
            ...
            <div class="alert alert-success" role="alert" id="bx">You have successfully deleted your registration
              <br>
              <br>
              <div class="loader">
                <div class="bar"></div>
              ...
              <br>
              <i>We will update your registration status in a few seconds. <strong>You can check it here and, if needed, register again.</strong></i>
            </div>
            ...
            messageOnSubmit.innerHTML = `<span class="alert alert-danger" role="alert">An error occurred while deleting your registration</span>`;
          }
        })
        .catch((error) => {
          console.error("Error:", error);
